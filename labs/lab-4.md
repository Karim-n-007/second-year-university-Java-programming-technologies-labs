...
Необходимо доработать существующее Spring Boot-приложение (реализованное в предыдущих лабораторных работах), добавив в него механизм аутентификации и авторизации с помощью Spring Security.

Существующий функционал банковской системы остаётся без изменений - добавляется только слой безопасности поверх уже реализованных эндпоинтов.
...
- Закрытая регистрация пользователей - только администраторы могут создавать новых пользователей и других администраторов
...
На сдаче необходимо продемонстрировать функциональность системы.
